      ...
      <div style={{position:"relative",zIndex:2,maxWidth:1020,margin:"0 auto",padding:"0 24px 80px"}}>
        ...
        {activeTab==="schedule" && (
          <div className="animate-in">
            ...
            <CsvWhitelist ownerAddress={address || privyAddress || ""} scheduler={SCHEDULER} abi={SCHEDULER_ABI} publicClient={publicClient} getPrivyProvider={getPrivyProvider} isPrivyConnected={isPrivyConnected} />
            </>
            )}
          </div>
        )}
